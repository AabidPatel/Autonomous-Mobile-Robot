...
Hoverboard::Hoverboard() {
    ...
    // Init PID controller
    pids[0].init(nh_left, 1.0, 0.01, 0.01, 0.0, 1.5, -1.5, true, max_velocity, -max_velocity);
    pids[0].setOutputLimits(-max_velocity, max_velocity);
    pids[1].init(nh_right, 1.0, 0.01, 0.01, 0.0, 1.5, -1.5, true, max_velocity, -max_velocity);
